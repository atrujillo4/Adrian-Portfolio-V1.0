        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <div class="navbar-nav">
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <a class="nav-item nav-link" data-toggle="collapse" data-target=".navbar-collapse.show" href="docs/Trujillo-Resume.pdf" target="_blank"><button>Resume</button></a>
                </ul>
...
<!-- 
    ...
    add about me from iphone notes
    Social medias (github, linkedin)
    fix navbar items 
    add my resume link 
        ...
        <div class="col-12 col-sm-12 col-md-9 col-lg-9 col-xl-9 my col">
            <div class="about-me">
                ...
                <div id="about-me-desc">
                    <p>
                        I'm Adrian, a freelance developer that is fascinated by technology. I first gained an interest in coding when I took an elective class at a local community college. I instantly fell in love with the idea that coding is limited by the imagination.
                    </p>
                    <p>
                    </p>
                </div>
